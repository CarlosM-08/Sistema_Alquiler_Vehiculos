 ...
 public class Proyecto_SistemaAlquilerVehiculos {
    ...
    public static void main(String[] args) {
        ...
        String[] vehiculo = {
            ...
            "Kia Rio", "Toyota RAV4", "Ford Explorer",
            "Honda CR-V", "Hyundai Tucson", "Toyota Hilux",
            "Ford Ranger", "Nissan Frontier", "Mitsubishi L200"
        };
        ...
        do {
            ...
            switch (eleccion) {
                ...
                case 1:
                    ...
                    cantidadClientes = registrarCliente(
                            input,
                            cliente,
                            edad,
                            identidad,
                ...
                case 3:
                    ...
                    if (posicionCliente != -1) {
                        ...
                        do {
                            ...
                            if (respuestaCategoriaVehiculo < 1
                                    || respuestaCategoriaVehiculo > 3) {
                                System.out.println("Eleccion no valida!!");
                            }

                        } while (respuestaCategoriaVehiculo < 1
                                || respuestaCategoriaVehiculo > 3);
                        ...
                        for (int i = 0; i < categoria.length; i++) {
                            ...
                            if (categoria[i].equals(categoriaSeleccionada)
                                    && disponibles[i] == true) {
                        ...
                        if (posicionVehiculo >= 0
                                && posicionVehiculo <= vehiculo.length - 1) {

                            if (categoria[posicionVehiculo].equals(categoriaSeleccionada)
                                    && disponibles[posicionVehiculo] == true) {
                                ...
                                System.out.println(
                                        ...
                                        + "o no pertenece a la categoría seleccionada"
                                );
                            }
