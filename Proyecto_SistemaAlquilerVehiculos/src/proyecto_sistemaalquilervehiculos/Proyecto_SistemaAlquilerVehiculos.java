...
public class Proyecto_SistemaAlquilerVehiculos {
    ...
    public static void main(String[] args) {
        ...
        String[] vehiculo = {"Toyota Corolla","Honda Civic","Toyota Rav4","Ford Explorer","Toyota Hilux"};
        String[] categoria = {"Economico","Economico","SUV","SUV","Pickup"};
        double[] tarifa = {30,35,50,60,55};
        ...
        switch (eleccion) {
            case 1:
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    if (respuestaRegistro.equals("SI")) {
                     ...
                     if(edad[i] >= 18) {
                        System.out.println("El cliente cumple con el requisito de edad.");
                     } else{
            ...
            case 2:
                ...
                for (int i = 0; i < 5; i++ ){
                    if (categoria[i].equals("Economico")) {
                ...
                System.out.print("Seleccione el vehiculo que desea alquilar:");
                 seleccionVehiculo = input.nextInt();
                        break;
                    case 2:
                        System.out.println("== Tipo de vehiculo seleccionado: SUV ==");
                for (int i = 0; i < 5; i++ ){
                    if (categoria[i].equals("SUV")) {
                        if(disponibles[i]== true) {
                    System.out.println((i + 1) + "." + vehiculo[i] + "-$" + tarifa[i]);
                ...
                System.out.println("Seleccione el vehiculo que deasea alquilar:");
                 seleccionVehiculo = input.nextInt();
                        break;
                case 3:
                         System.out.println("== Tipo de vehiculo seleccionado: Pickup ==");
                       for (int i = 0; i < 5; i++ ){
                    if (categoria[i].equals("Pickup")) {
                        if(disponibles[i]== true) {
                    System.out.println((i + 1) + "." + vehiculo[i] + "-$" + tarifa[i]);
